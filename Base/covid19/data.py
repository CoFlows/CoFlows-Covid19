...
def Load():
    ...
    covid19_confirmed_url = 'https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv'
    covid19_death_url = 'https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv'

    # covid19_recovered_url = 'https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv'
    ...
    # print(covid19_confirmed_pd)
    # print(covid19_death_pd)
    # print(covid19_recovered_pd)
    ...
    union = unitePD(covid19_confirmed_pd, covid19_death_pd)
    ...
    for index, row in countries_provinces_pd.iterrows():
        ...
        __union_change = __union_change.append(res_pd)

    # print(__union_change)
    ...
    for start_idx in starting_dates:
        ...
        for index, row in countries_provinces_pd.iterrows():
            ...
            # pd_0 = _union_change_0[(_union_change_0['Country/Region'] == country_region) & (_union_change_0['Province/State'] == province_state)][['Province/State', 'confirmed']].rename(columns={'confirmed': name }).drop_duplicates().drop(columns=['Province/State'])
        ...
        for index, row in countries_provinces_pd.iterrows():
            ...
            province_state = country_region if province_state == 'nan' else province_state
            name = country_region if province_state == 'All' else country_region + ' / ' + province_state
            pd_0 = _union_change_0[(_union_change_0['Country/Region'] == country_region) & (_union_change_0['Province/State'] == province_state)][['Province/State', 'growth']].rename(columns={'growth': name }).drop_duplicates().drop(columns=['Province/State'])
            # pd_0 = pd_0.drop_duplicates()
        ...
        for index, row in countries_provinces_pd.iterrows():
            ...
            province_state = country_region if province_state == 'nan' else province_state
            name = country_region if province_state == 'All' else country_region + ' / ' + province_state
            pd_0 = _union_change_0[(_union_change_0['Country/Region'] == country_region) & (_union_change_0['Province/State'] == province_state)][['Province/State', 'death']].rename(columns={'death': name }).drop_duplicates().drop(columns=['Province/State'])
            # pd_0 = pd_0.drop_duplicates()
